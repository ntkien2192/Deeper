...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Deeper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Deeper17ApplicationScreen")
@interface ApplicationScreen : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC6Deeper13BusinessQueue")
@interface BusinessQueue : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC6Deeper20CollectionCellConfig")
@interface CollectionCellConfig : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC6Deeper5Value")
@interface Value : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Deeper7Content")
@interface Content : Value
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC6Deeper7Control")
...
SWIFT_CLASS("_TtC6Deeper12DeeperConfig")
@interface DeeperConfig : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Deeper5Image")
@interface Image : Value
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC6Deeper8Localize")
...
SWIFT_CLASS("_TtC6Deeper14StartViewModel")
@interface StartViewModel : ViewModel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface UICollectionView (SWIFT_EXTENSION(Deeper)) <UICollectionViewDelegateFlowLayout>
@end
...
@interface UILabel (SWIFT_EXTENSION(Deeper))
- (void)awakeFromNib;
@end
...
SWIFT_CLASS("_TtC6Deeper20ViewControllerConfig")
@interface ViewControllerConfig : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC6Deeper12WelcomeStore")
@interface WelcomeStore : Store
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Deeper16WelcomeViewModel")
@interface WelcomeViewModel : ViewModel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
